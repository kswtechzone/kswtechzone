...
export default function EditFaqPage({ params }: { params: { id: string } }) {
  ...
  if (fetching) return <div className="text-center py-12 text-slate-400">Loading FAQ...</div>;
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 p-8">
        <h1 className="text-2xl font-bold text-slate-900 mb-8">Edit FAQ</h1>
