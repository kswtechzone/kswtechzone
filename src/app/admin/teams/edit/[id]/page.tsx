...
export default function EditTeamPage({ params }: { params: { id: string } }) {
  ...
  const fetchMember = async (t: string) => {
    try {
  ...
  if (fetching) return <div className="text-center py-12 text-slate-400">Loading team member...</div>;
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 p-8">
        <h1 className="text-2xl font-bold text-slate-900 mb-8">Edit Team Member</h1>
